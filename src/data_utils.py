...
def get_feature_target(
    ...
    if "TARGET" not in app_train.columns:
        raise ValueError("La columna 'TARGET' no está presente en app_train.")
    if "TARGET" not in app_test.columns:
        raise ValueError("La columna 'TARGET' no está presente en app_test.")
    print("Aparentemente todo en orden.")
